...
"""
        ...
        assert len(analysis.patterns) >= 0  # May or may not find patterns depending on similarity
...
"""
        ...
        refactored = self.detector.refactor_code_with_utilities(original_code, [utility_func])
