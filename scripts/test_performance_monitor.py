...
class TestPerformanceMonitor:
    ...
    def __init__(self, db_path: Optional[Path] = None):
        self.db_path = db_path or Path.home() / ".cache" / "pyspark_tools_test" / "performance.sqlite"
    ...
    def get_test_performance_history(self, test_name: str, days: int = 30) -> List[TestPerformanceMetric]:
...
def main():
    ...
    parser.add_argument("--regressions", action="store_true", help="Show performance regressions")
